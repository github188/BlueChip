// sdk_uv200.h : main header file for the SDK_uv200 DLL
//
...
#if !defined(AFX_SDK_UV200_H__37FDA63D_0A84_4797_9E52_320E37C41382__INCLUDED_)
#define AFX_SDK_UV200_H__37FDA63D_0A84_4797_9E52_320E37C41382__INCLUDED_



static const ULONG BrightnessDefault = 128;//0x80;
static const ULONG ContrastDefault   = 128;//0x44;
static const ULONG SaturationDefault = 128;//0x40;
static const ULONG HueDefault        = 128;//0x00;
static const ULONG SharpnessDefault  = 128;//0x00;
...
//连接设备
HRESULT	WINAPI VCAConnectDevice(int nCards, BOOL bOverlay, HWND hParentWnd, SIZE& szVidSize, VIDEOSOURCE enVideoSource, int nFrameRate = 25, VideoSubType enVideoSubType = VideoSubType_UYVY);
//断开设备
...
#endif // !defined(AFX_SDK_UV200_H__37FDA63D_0A84_4797_9E52_320E37C41382__INCLUDED_)
