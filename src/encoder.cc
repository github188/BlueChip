...
void CEncoder::compress_begin(Encoder* en,int width, int height) {
...
int CEncoder::compress_frame(Encoder* en,int type, uint8_t *in, uint8_t *out) {
...
void CEncoder::compress_end(Encoder* en) {
	if (en->picture) {
